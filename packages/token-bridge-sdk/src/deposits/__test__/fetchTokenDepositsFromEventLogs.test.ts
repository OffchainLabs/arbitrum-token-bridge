...
describe('fetchTokenDepositsFromEventLogs', () => {
  it('fetches no token deposits from event logs pre-nitro', async () => {
  ...
  it('fetches some token deposits from event logs pre-nitro', async () => {
    const result = await fetchTokenDepositsFromEventLogs(
      getQueryCoveringClassicOnlyWithResults()
    )
  ...
  it('fetches some token deposits from event logs pre-nitro and post-nitro', async () => {
    const result = await fetchTokenDepositsFromEventLogs(
      getQueryCoveringClassicAndNitroWithResults()
    )
