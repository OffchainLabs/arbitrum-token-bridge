...
import { L1ToL2MessageStatus, L2ToL1MessageStatus as OutgoingMessageState } from '@arbitrum/sdk';
import { EthDepositMessage, L1ToL2MessageReader, L1ToL2MessageReaderClassic } from '@arbitrum/sdk/dist/lib/message/L1ToL2Message';
...
import { L1EthDepositTransaction, L1EthDepositTransactionReceipt, L1ContractCallTransaction, L1ContractCallTransactionReceipt } from '@arbitrum/sdk/dist/lib/message/L1Transaction';
import { L2ContractTransaction, L2TransactionReceipt } from '@arbitrum/sdk/dist/lib/message/L2Transaction';
import { FailedTransaction, NewTransaction, Transaction, L1ToL2MessageData } from './useTransactions';
...
export type L1EthDepositTransactionLifecycle = TransactionLifecycle<L1EthDepositTransaction, L1EthDepositTransactionReceipt>;
export type L1ContractCallTransactionLifecycle = TransactionLifecycle<L1ContractCallTransaction, L1ContractCallTransactionReceipt>;
export type L2ContractCallTransactionLifecycle = TransactionLifecycle<L2ContractTransaction, L2TransactionReceipt>;
export declare enum NodeBlockDeadlineStatusTypes {
    NODE_NOT_CREATED = 0,
    EXECUTE_CALL_EXCEPTION = 1
}
export type NodeBlockDeadlineStatus = number | NodeBlockDeadlineStatusTypes.NODE_NOT_CREATED | NodeBlockDeadlineStatusTypes.EXECUTE_CALL_EXCEPTION;
...
export interface TransactionActions {
    ...
    updateTransaction: (txReceipt: TransactionReceipt, tx?: ethers.ContractTransaction, l1ToL2MsgData?: L1ToL2MessageData) => void;
    fetchAndUpdateL1ToL2MsgStatus: (txID: string, l1ToL2Msg: L1ToL2MessageReader, isEthDeposit: boolean, status: L1ToL2MessageStatus) => void;
    fetchAndUpdateL1ToL2MsgClassicStatus: (txID: string, l1ToL2Msg: L1ToL2MessageReaderClassic, isEthDeposit: boolean, status: L1ToL2MessageStatus) => void;
    fetchAndUpdateEthDepositMessageStatus: (txID: string, ethDepositMessage: EthDepositMessage) => void;
}
export type ArbTokenBridgeTransactions = {
    transactions: Transaction[];
} & Pick<TransactionActions, 'addTransaction' | 'clearPendingTransactions' | 'setTransactionConfirmed' | 'updateTransaction' | 'addTransactions' | 'fetchAndUpdateL1ToL2MsgStatus' | 'fetchAndUpdateL1ToL2MsgClassicStatus' | 'fetchAndUpdateEthDepositMessageStatus' | 'setDepositsInStore'>;
