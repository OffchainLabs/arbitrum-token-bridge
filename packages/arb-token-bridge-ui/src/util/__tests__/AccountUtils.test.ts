...
const EXTERNALLY_OWNER_ACCOUNT = '0x6d051646D4A9df8679E9AD3429e70415f75f6499'
...
describe('getAccountType', () => {
  describe('on Sepolia', () => {
    it('should return externally-owned-account for EXTERNALLY_OWNER_ACCOUNT', async () => {
      const result = await getAccountType({
        address: EXTERNALLY_OWNER_ACCOUNT,
