...
export const useArbTokenBridge = (): ArbTokenBridge => {
  ...
  // useEffect(() => {
  //   console.log('addL2NativeToken?')
  // }, [addL2NativeToken])

  // useEffect(() => {
  //   console.log('addTokensFromList?')
  // }, [addTokensFromList])

  // useEffect(() => {
  //   console.log('removeTokensFromList?')
  // }, [removeTokensFromList])

  // useEffect(() => {
  //   console.log('addBridgeTokenListToBridge?')
  // }, [addBridgeTokenListToBridge])
  ...
  // useEffect(() => {
  //   console.log('triggerOutboxToken?')
  // }, [triggerOutboxToken])
