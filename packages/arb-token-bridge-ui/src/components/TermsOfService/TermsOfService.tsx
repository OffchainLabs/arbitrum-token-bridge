  ...
  return (
    <div>
      ...
      <p className="mb-4">
        ...
        website-hosted user interface (the “Interface”) for accessing Arbitrum,
        an optimistic rollup protocol on the Ethereum blockchain (the
        “Protocol”), and related content and functionality to you through our
        websites located at https://offchainlabs.com/, https://arbitrum.io/ and
        any other website operated by Offchain Labs on which these Terms of
        Service are posted (collectively, the “Site”) and through our related
        technologies (collectively, the Interface, Protocol and Site, including
        all existing and any updated or new features, functionality and
        technology, the “Service”). All access and use of the Service is subject
        to the terms and conditions contained in these Terms of Service (as
        amended from time to time, these “Terms of Service”). By accessing,
        browsing, or otherwise using the Site, the Interface, or any other
        aspect of the Service, you acknowledge that you have read, understood,
        and agree to be bound by these Terms of Service. If you are using the
        Service on behalf of an entity or other organization, you are agreeing
        to these Terms of Service for that entity or organization and
        representing to Offchain Labs that you have the authority to bind that
        entity or organization to these Terms of Service (and, in which case,
        the terms “you” and “your” will refer to that entity or organization).
        If you do not accept the terms and conditions of these Terms of Service,
      ...
      <p className="mb-4">
        ...
        of Service” link on the Site. Your continued use of the Service after
      ...
      <p className="mb-4">
        <b>Your Privacy:</b> For more information regarding our collection, use
        and disclosure of personal data and certain other data, please see our
        Privacy Policy, located at
        https://www.iubenda.com/privacy-policy/76750372 (the “Privacy Policy”).
        By using the Service, you consent to our collection, use and disclosure
        of Personal Data and other data as outlined therein.
      </p>
      <p className="mb-4"></p>
      <p className="mb-4">
        ...
        from time to time. All such terms are hereby incorporated by reference
      ...
      <p className="mb-4">
        ...
        part thereof) with or without notice. You agree that Offchain Labs will
        not be liable to you or to any third party for any modification,
        suspension or discontinuance of the Service.
      </p>
      <p className="mb-4">
        <b>Your Apps</b> : As between Offchain Labs and you, you will be solely
        responsible for your applications (“Your Apps”), including their
        development, operation, maintenance and all related content and
        materials.
      </p>
      ...
      <p className="mb-4">
        ...
        available to Offchain Labs, including by uploading, posting, publishing,
        or displaying (hereinafter, “upload(ing)”) via the Site or Your Apps or
        by emailing or otherwise making available to other users of the Site
        (collectively, “User Content”). The following are examples of the kinds
        of content and/or uses that are illegal or prohibited by Offchain Labs.
        Offchain Labs reserves the right to investigate and take appropriate
        legal action against anyone who, in Offchain Labs’ sole discretion,
        violates this provision, including reporting the violator to law
        enforcement authorities. You agree to not use the Service or Your Apps
        to:
      </p>
      <p className="mb-4">
        <ol>
      ...
      <p className="mb-4">
        ...
        measures to circumvent such blocking (e.g., by masking your IP address
        or using a proxy IP address or virtual private network).
      </p>
      ...
      <p className="mb-4">
        ...
        contained in the Service. Before you make any financial, legal, or other
        decisions involving the Service, you should seek independent
      ...
      <p className="mb-4">
        These Terms of Service are not intended to, and do not, create or impose
        any fiduciary duties on us. To the fullest extent permitted by law, you
        ...
        out expressly in these Terms of Service.
      </p>
      ...
      <p className="mb-4">
        ...
        and laws. Except as expressly authorized by Offchain Labs (e.g., to the
        extent any of the Protocol is made available under an open source
        license), you agree not to modify, copy, frame, scrape, rent, lease,
        ...
        upload to or make available through the Service in accordance with these
      ...
      <p className="mb-4">
        ...
        or connected to Offchain Labs. Nothing in these Terms of Service or the
        Service should be construed as granting, by implication, estoppel, or
        otherwise, any license or right to use any of Offchain Labs Trademarks
        displayed on the Service, without our prior written permission in each
        instance. All goodwill generated from the use of Offchain Labs
        Trademarks will inure to our exclusive benefit.
      </p>
      <p className="mb-4">
        <b>Third-Party Material:</b>Under no circumstances will Offchain Labs be
        liable in any way for any content or materials of any third parties
        (including users), including for any errors or omissions in any content,
        or for any loss or damage of any kind incurred as a result of the use of
        any such content. You acknowledge that Offchain Labs does not pre-screen
        content, but that Offchain Labs and its designees will have the right
        (but not the obligation) in their sole discretion to refuse or remove
        any content that is available via the Site. Without limiting the
        foregoing, Offchain Labs and its designees will have the right to remove
        from the Site any content that violates these Terms of Service or is
        deemed by Offchain Labs, in its sole discretion, to be otherwise
      ...
      <p className="mb-4">
        ...
        via the Site, including all copyrights and rights of publicity contained
        therein.
      </p>
      <p className="mb-4">
        You hereby grant Offchain Labs and its affiliated companies, successors,
        and assigns a non-exclusive, worldwide, royalty-free, fully paid-up,
        ...
        perform, distribute, store, modify, and otherwise use such User Content
        in connection with the operation of the Site. You assume all risk
        associated with your User Content and the transmission of your User
        Content, and you have sole responsibility for the accuracy, quality,
        legality and appropriateness of your User Content. You hereby authorize
        Offchain Labs and its third-party service providers to derive
        statistical and usage data relating to your use of the Site (“Usage
        Data”). We may use Usage Data for any purpose in accordance with
      ...
      <p className="mb-4">
        ...
        Offchain Labs are non-confidential and Offchain Labs will be entitled to
      ...
      <p className="mb-4">
        ...
        and may also disclose User Content if required to do so by law or in the
        ...
        protect the rights, property, or personal safety of Offchain Labs, its
      ...
      <p className="mb-4">
        The Service provides access to services, sites, technology, applications
        and resources that are provided or otherwise made available by third
        parties (the “Third-Party Services”). Your access and use of the
        ...
        Offchain Labs has no control over and is not responsible for such
        Third-Party Services, including for the accuracy, availability,
        reliability, or completeness of information shared by or available
        through Third-Party Services, or on the privacy practices of Third-Party
        Services. We encourage you to review the privacy policies of the third
        parties providing Third-Party Services prior to using such services.
        You, and not Offchain Labs, will be responsible for any and all costs
        and charges associated with your use of any Third-Party Services. The
        ...
        while using the Service are between you and the third party. Offchain
        Labs will not be responsible or liable, directly or indirectly, for any
      ...
      <p className="mb-4">
        ...
        affiliates, and its and their respective officers, employees, directors,
        service providers, licensors, and agents (collectively, the “Offchain
        Labs Parties”) from any and all losses, damages, expenses, including
        ...
        Service, Your Apps, any User Content, your connection to the Service,
        your violation of these Terms of Service, or your violation of any
        rights of another. Offchain Labs will provide notice to you of any such
        claim, suit, or proceeding. Offchain Labs reserves the right to assume
      ...
      <p className="mb-4">
        ...
        AN “AS IS” AND “AS AVAILABLE” BASIS. THE OFFCHAIN LABS PARTIES EXPRESSLY
      ...
      <p className="mb-4">
        ...
        CRYPTOGRAPHIC AND BLOCKCHAIN-BASED SYSTEMS SUCH AS ARBITRUM AND ETHEREUM
        ...
        INCLUDING THE INTERFACE TO INTERACT WITH THE PROTOCOL.
      </p>
      ...
      <p className="mb-4">
        ...
        these Terms of Service as the “Arbitration Agreement.” You agree that
        any and all disputes or claims that have arisen or may arise between you
        and Offchain Labs, whether arising out of or relating to these Terms of
        Service (including any alleged breach thereof), the Service, any
        advertising, or any aspect of the relationship or transactions between
        us, will be resolved exclusively through final and binding arbitration,
        ...
        state, or local agencies, and such agencies can, if the law allows, seek
        relief against us on your behalf. You agree that, by entering into these
        Terms of Service, you and Offchain Labs are each waiving the right to a
      ...
      <p className="mb-4">
        YOU AND OFFCHAIN LABS AGREE THAT EACH OF US MAY BRING CLAIMS AGAINST THE
        ...
        BOTH YOU AND OFFCHAIN LABS AGREE OTHERWISE, THE ARBITRATOR MAY NOT
      ...
      <p className="mb-4">
        ...
        Labs should be sent to 252 Nassau Street, Floor 2, Princeton, New Jersey
        08542 (“Notice Address”). The Notice must (i) describe the nature and
        basis of the claim or dispute and (ii) set forth the specific relief
        sought. If Offchain Labs and you do not resolve the claim within sixty
        (60) calendar days after the Notice is received, you or Offchain Labs
        may commence an arbitration proceeding. During the arbitration, the
        amount of any settlement offer made by Offchain Labs or you will not be
        disclosed to the arbitrator until after the arbitrator determines the
        amount, if any, to which you or Offchain Labs is entitled.
      </p>
      ...
      <p className="mb-4">
        ...
        the AAA, please visit its website, http://www.adr.org. Information about
      ...
      <p className="mb-4">
        ...
        Offchain Labs agrees that you may choose whether the arbitration will be
      ...
      <p className="mb-4">
        ...
        value of the relief sought is $75,000 or less, at your request, Offchain
        Labs will pay all Arbitration Fees. If the value of relief sought is
        more than $75,000 and you are able to demonstrate to the arbitrator that
        you are economically unable to pay your portion of the Arbitration Fees
        or if the arbitrator otherwise determines for any reason that you should
        not be required to pay your portion of the Arbitration Fees, Offchain
        Labs will pay your portion of such fees. In addition, if you demonstrate
        to the arbitrator that the costs of arbitration will be prohibitive as
        compared to the costs of litigation, Offchain Labs will pay as much of
        the Arbitration Fees as the arbitrator deems necessary to prevent the
        arbitration from being cost-prohibitive. Any payment of attorneys’ fees
      ...
      <p className="mb-4">
        ...
        Offchain Labs agrees that if it makes any future change to this
        ...
        Offchain Labs written notice within thirty (30) calendar days of the
      ...
      <p className="mb-4">
        ...
        other user in connection with the Service, and Offchain Labs will have
        no liability or responsibility with respect thereto. Offchain Labs
      ...
      <p className="mb-4">
        ...
        conditions that may apply when you use Third-Party Services, third-party
        content or third-party software. These Terms of Service will be governed
        by the laws of the State of Delaware without regard to its conflict of
        law provisions. With respect to any disputes or claims not subject to
        arbitration, as set forth above, you and Offchain Labs submit to the
        personal and exclusive jurisdiction of the state and federal courts
        located within New York, New York. The failure of Offchain Labs to
        ...
        or be forever barred. A printed version of these Terms of Service and of
        any notice given in electronic form will be admissible in judicial or
        ...
        prior written consent of Offchain Labs, but Offchain Labs may assign or
        ...
        Service. Offchain Labs will not be in default hereunder by reason of any
        ...
        beyond Offchain Labs’ reasonable control.
      </p>
      <h3 className="font-semibold mb-2">U.S. Government Restricted Rights</h3>
      <p className="mb-4">
      ...
      <h3 className="font-semibold mb-2">Questions? Concerns? Suggestions?</h3>
      <p className="mb-4">
