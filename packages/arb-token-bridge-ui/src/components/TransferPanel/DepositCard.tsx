    ...
    >
      <div className="relative flex flex-col items-center gap-6 lg:flex-row">
        ...
        <Image
          ...
          className="absolute left-0 top-[1px] z-10 h-8 max-h-[90px] w-auto p-[2px] lg:relative lg:left-[-30px] lg:top-0 lg:h-[4.5rem] lg:w-[initial] lg:max-w-[90px] lg:translate-x-[-0.75rem] lg:scale-125 lg:opacity-[60%]"
          alt="Deposit"
          height={90}
          width={90}
        />
