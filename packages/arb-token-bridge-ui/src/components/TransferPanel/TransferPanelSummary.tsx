  ...
  return (
    <>
      <div className="block lg:hidden">
        <span className="text-xl text-gray-7 lg:text-2xl">Summary</span>
        <div className="h-4" />
      </div>
...
export function TransferPanelSummary({
  ...
  return (
    <TransferPanelSummaryContainer>
      <div className="flex flex-row justify-between text-sm text-gray-7 lg:text-base">
      ...
      <div className="flex flex-row items-center justify-between text-sm text-gray-7 lg:text-base">
      ...
      <div className="flex flex-col space-y-2 text-sm text-gray-6 lg:text-base">
        ...
        <div className="flex flex-row justify-between text-gray-6">
          <div className="flex flex-row items-center space-x-2">
      ...
      {isETH && (
        <>
          ...
          <div className="flex flex-row justify-between text-sm text-gray-7 lg:text-base">
            <span className="w-2/5 font-light text-gray-6">Total amount</span>
            <div className="flex w-3/5 flex-row justify-between">
              <span>
