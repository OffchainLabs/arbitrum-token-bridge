          ...
          <div className="flex flex-col space-y-4">
            <Checkbox
              label={
                <span className="font-light">
                  ...
                  can claim my funds on {destinationNetworkName}
                </span>
              }
            ...
            {fastWithdrawalActive && (
              <Checkbox
                label={
                  <span className="font-light">
                    I understand that ~{confirmationPeriod} is an estimate, and
                    it&apos;s possible the committee fails and it will default
                    back to the 8 days.{' '}
                    <ExternalLink
