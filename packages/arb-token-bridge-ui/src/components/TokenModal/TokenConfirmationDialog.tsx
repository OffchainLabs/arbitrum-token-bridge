...
export default function TokenConfirmationDialog({
  open,
  setOpen,
  onAdd
}: {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      This token is not whitelisted. Proceed at your own risk.
                      Are you sure you want to add this token to the list?
                    </p>
                  </div>
                </div>
              </div>
