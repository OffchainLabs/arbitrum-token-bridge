...
export function HeaderNetworkNotSupported() {
  return (
    <div className="flex flex-col">
      <div className="flex flex-row items-center justify-center space-x-3 rounded-full px-4 py-3 lg:bg-brick-dark text-white">
        <InformationCircleIcon className="h-6 w-6 text-brick lg:text-white" />
        <span className="text-2xl text-brick lg:text-base">
          Wrong network
        </span>
