      ...
      <div className="toggle-switch flex flex-col text-white/70 duration-200 hover:text-white">
        <div className="flex items-center gap-3">
          <HeadlessSwitch
            ...
            onChange={onChange}
            className={twMerge(
              'relative inline-flex h-3 w-7 items-center rounded-full transition-colors ui-checked:bg-white ui-not-checked:bg-white/50 [&:disabled]:cursor-not-allowed [.toggle-switch:hover_&]:ui-not-checked:bg-white [label:hover_&]:ui-not-checked:bg-white',
