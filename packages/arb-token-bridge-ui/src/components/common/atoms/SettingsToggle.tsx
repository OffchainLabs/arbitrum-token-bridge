...
export function SettingsToggle() {
  ...
  return (
    <button
      className="arb-hover flex w-full items-center gap-3 rounded-full px-6 py-3 lg:bg-[#333333] lg:p-2"
    ...
    >
      <span className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-header-menu lg:h-auto lg:w-auto lg:bg-transparent">
        <Cog6ToothIcon className="text-default-black h-5 w-5 stroke-2 lg:h-4 lg:w-4 lg:text-white" />
      </span>
