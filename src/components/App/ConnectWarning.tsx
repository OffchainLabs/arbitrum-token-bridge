...
export default ()=>{
       ...
       return  <Container>
          <Alert variant={'danger'}> {`Unsupported network; connect to ${l1NetworkName} for L1 actions or ${l2NetworkName} for L2 actions`}</Alert>
          <Row>
              <Col style={{border: "0px solid black"}} className="text-center"> <h5> {l1NetworkName} (deposit into Arbitrum)</h5>
              ...
              <div style={{minHeight: "50px", fontSize: "12px"}}> Connect to<a href="https://developer.offchainlabs.com/docs/Developer_Quickstart/">  your own aggregator</a> or to our publically hosted node at <b>https://node.offchainlabs.com:8547</b> via Custom RPC</div>
