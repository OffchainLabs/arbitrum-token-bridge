...
export default () => {
  ...
  return (
    <Container>
      ...
      <br />
      <h3>Acceptance of These Terms of Service</h3>
      <p>
      ...
      <p>
        ...
        Under no circumstances will Offchain Labs be liable in any way for any
        content or materials of any third parties (including users), including
        for any errors or omissions in any content, or for any loss or damage of
        any kind incurred as a result of the use of any such content. You
        acknowledge that Offchain Labs does not pre-screen content, but that
        Offchain Labs and its designees will have the right (but not the
        obligation) in their sole discretion to refuse or remove any content
        that is available via the Site. Without limiting the foregoing, Offchain
        Labs and its designees will have the right to remove from the Site any
        content that violates these Terms of Service or is deemed by Offchain
        Labs, in its sole discretion, to be otherwise objectionable. You agree
      ...
      <p>
        ...
        and to such User Content that you make available via the Site, including
