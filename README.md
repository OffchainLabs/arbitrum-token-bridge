...
1. Set up the Nitro test-node
   ...
   2. Check out the [Nitro test-node repo](https://github.com/OffchainLabs/nitro-testnode)
   ...
   4. When the Nitro test-node is up and running you should see logs like `sequencer_1` and `staker-unsafe_1` in the terminal. This can take up to 10 minutes
